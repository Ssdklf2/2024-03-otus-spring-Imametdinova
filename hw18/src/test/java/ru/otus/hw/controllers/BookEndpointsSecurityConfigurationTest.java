...
class BookEndpointsSecurityConfigurationTest {
    ...
    public static Stream<Arguments> getTestData() {
        ...
        var authorRoles = new String[]{"USER", "AUTHOR"};

        var bookRequest = new BookRequestDto(null, "title", "a1", "g1");
        return Stream.of(
                Arguments.of("get", "/books", "user", userRoles, 200, null),
                Arguments.of("get", "/books/" + DEFAULT_ID, "user", userRoles, 200, null),
                Arguments.of("get", "/books/create", "user", userRoles, 403, null),
                Arguments.of("get", "/books/edit/" + DEFAULT_ID, "user", userRoles, 403, null),
                Arguments.of("get", "/api/books", "user", userRoles, 200, null),
                Arguments.of("get", "/api/books/" + DEFAULT_ID, "user", userRoles, 200, null),
                Arguments.of("post", "/api/books", "user", userRoles, 403, bookRequest),
                Arguments.of("put", "/api/books/" + DEFAULT_ID, "user", userRoles, 403, bookRequest),
                Arguments.of("delete", "/api/books/" + DEFAULT_ID, "user", userRoles, 403, null),
                ...
                Arguments.of("get", "/books/create", "author", authorRoles, 200, null),
                Arguments.of("get", "/books/edit/" + DEFAULT_ID, "author", authorRoles, 200, null),
                Arguments.of("post", "/api/books", "author", authorRoles, 200, bookRequest),
                Arguments.of("put", "/api/books/" + DEFAULT_ID, "author", authorRoles, 200, bookRequest),
                Arguments.of("delete", "/api/books/" + DEFAULT_ID, "author", authorRoles, 204, null)
        );
    }
